...
public class CYTC_029PrintReport {
	private WebDriver driver;
	private String baseUrl;
	private ReportMemberPOM RepPOM;
	...
	public void setUp() throws Exception {
		...
		RepPOM= new ReportMemberPOM(driver); 
	...
	public void ManageLoan() throws InterruptedException {
		...
		RepPOM.clickLoginBtn(); 
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		
		RepPOM.clickreport();
		RepPOM.clickmember();
		RepPOM.clickselectall();
		RepPOM.printreport();
